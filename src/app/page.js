        ...
        <div className="container hero-grid items-center">
          <div className="space-y-8 text-left">
            ...
            <motion.p
              ...
              className="hero-copy"
            >
              Product-minded frontend engineer helping venture-backed teams
              shape concepts into emotive, shippable product experiences. I mix
              design systems, motion craft, and AI tooling to deliver
              interfaces that feel effortless and unforgettable.
            </motion.p>
            ...
            <motion.ul
              ...
              className="hero-meta"
            >
              <li>⚡ Rapid product sprints that ship aligned, testable UX within days.</li>
              <li>🎯 Narrative-driven delivery — crisp storytelling from deck to demo.</li>
              <li>🤖 Practical AI integrations that are reliable, observable, and safe.</li>
            </motion.ul>
          </div>
